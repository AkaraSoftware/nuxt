        ...
        <div v-for="(topic, index) in topics" :key="index" class="bg-light mt-5 mb-5" style="padding:20px;">
            ...
            <div v-if="authenticated">
                <div v-if="user.id===topic.user.id">
                    <button @click="deleteTopic(topic.id)" class="btn btn-outline-danger fa fa-trash fa-2x float-right"></button>
            ...
            <div v-for="(content, index) in topic.posts" :key="index" class="ml-5 content">
                ...
                <!-- add likes button -->
                <div class="btn outline-primary fa fa-thumbs-up ml-5 mb-2" @click="likePost(topic.id,content)">
